...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject creates an operand and a function which may call the operand and an item.
    # The function is performed on each item in the list.
  end
  ...
  # The former method automatically closes the file when we exit the block.
